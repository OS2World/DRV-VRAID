/*
 * $Source: R:/source/driver/sleep/RCS/Printk.c,v $
 * $Revision: 1.2 $
 * $Date: 1997/12/05 01:18:35 $
 * $Author: vitus $
 *
 * Simple sprintf-like function
 *
 * $Log: Printk.c,v $
 * Revision 1.2  1997/12/05 01:18:35  vitus
...
static char id[]="$Id: Printk.c,v 1.2 1997/12/05 01:18:35 vitus Exp $";
