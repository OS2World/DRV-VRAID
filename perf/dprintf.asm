...
;	$Source: e:/source/driver/perf/RCS/dprintf.asm,v $
...
;/*									*/
;/* $Log: dprintf.asm,v $
;/* Revision 1.1  1997/06/04 23:37:46  vitus
;/* Initial revision
;/*
;/* Revision 1.1  1997/05/07 23:56:42  vitus
;/* Initial revision
;/*
;/* Revision 1.1  1995/10/18 11:06:14  vitus
;/* Initial revision
;/*								*/
;/***********************************************************************/
