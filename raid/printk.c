/*
 * $Source: R:/source/driver/raid/RCS\\printk.c,v $
 * $Revision: 1.2 $
 * $Date: 1999/05/24 16:08:04 $
 * $Locker:  $
 *
 * Simple sprintf-like function
 *
 * $Log: printk.c,v $
 * Revision 1.2  1999/05/24 16:08:04  vitus
 * - surrounded WatCom pragma's with #ifdef.  MS-C complains.
 *
 * Revision 1.1  1998/02/17 23:11:41  vitus
 * Initial revision
 */
#if defined(__WATCOMC__)
# pragma off (unreferenced)
#endif
static char vcid[]="$Id: printk.c,v 1.2 1999/05/24 16:08:04 vitus Exp $";
#if defined(__WATCOMC__)
