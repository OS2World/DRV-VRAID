/*
 * $Source: /home/vitus/Data/Source/driver/raid/RCS/raid5.c,v $
 * $Revision: 1.1 $
 * $Date: 2008/09/23 06:23:41 $
 * $Locker:  $
 *
 *	How to do RAID5 I/O.
 *
 ...
 *
 * $Log: raid5.c,v $
 * Revision 1.1  2008/09/23 06:23:41  vitus
 * Initial revision
 *
 * ---------------------------------------------
 * This code is Copyright Vitus Jensen 2000-2001
 */
static char const id[]="$Id: raid5.c,v 1.1 2008/09/23 06:23:41 vitus Exp $";
