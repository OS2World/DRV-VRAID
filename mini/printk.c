/*
 * $Source: r:/source/driver/mini/RCS/printk.c,v $
 * $Revision: 1.1 $
 * $Date: 2000/06/12 01:19:24 $
 * $Locker:  $
 *
 * 	Simple sprintf-like function
 *
 * $Log: printk.c,v $
 * Revision 1.1  2000/06/12 01:19:24  vitus
 * Initial revision
 *
 */
static char vcid[]="$Id: printk.c,v 1.1 2000/06/12 01:19:24 vitus Exp $";
